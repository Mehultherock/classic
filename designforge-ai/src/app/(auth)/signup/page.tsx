...
export default function SignupPage() {
  ...
  const onSubmit = async (data: SignupForm) => {
    try {
      ...
      if (authData.session) {
        toast.success("Welcome to DesignForge AI!");
    ...
    <AuthLayout>
      <div className="glass rounded-2xl p-8 space-y-6">
        ...
        >
          ...
          <p className="text-muted-foreground mt-1">Start designing with AI in minutes</p>
        </motion.div>
        ...
        >
          ...
          {errors.acceptTerms && (
            <p className="text-xs text-error -mt-2">{errors.acceptTerms.message}</p>
          )}
