...
import {
  MousePointer2, Type, Image, Square, Upload, Palette,
  Undo2, Redo2, ZoomIn, ZoomOut, History,
} from "lucide-react";
...
export default function CanvaToolbar() {
  ...
  return (
    <div className="w-14 flex flex-col items-center py-3 gap-1 glass border-r border-border z-30">
      ...
      {activeTool === "shape" && (
        <div className="absolute left-16 top-1/2 -translate-y-1/2 glass-strong rounded-xl p-3 z-40 min-w-[160px]">
          <div className="text-xs font-medium text-muted-foreground mb-2">Shapes</div>
